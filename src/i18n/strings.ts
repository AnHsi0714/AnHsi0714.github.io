export interface Strings {
  ...
  home: {
    ...
    featuredArticlesGoto: (group: number) => string;
    explore: string;
    advisor: string;
...
export const strings: Record<"zh" | "en", Strings> = {
  zh: {
    ...
    playground: {
      ...
      miniWorks: {
        ...
        brandGuideLabel: "品牌視覺",
        brandGuideDesc: "動畫網頁課程作業：品牌網頁視覺引導",
        weatherBoxLabel: "動態互動天氣盒子",
    ...
    home: {
      ...
      featuredArticlesGoto: (group: number) => `切換至第 ${group} 組精選文章`,
      explore: "更多內容",
      advisor: "指導教授：",
    ...
    about: {
      ...
      researchStatement: "研究動機",
      academicAchievements: "學術成果",
      experience: "競賽與經歷",
  ...
  en: {
    ...
    home: {
      ...
      featuredArticlesGoto: (group: number) =>
        `Go to featured article group ${group}`,
      explore: "Explore",
      advisor: "Advisor: ",
