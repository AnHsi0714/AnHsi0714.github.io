...
問卷回饋中，「逐行執行動畫」是評分最高的視覺化功能（4.18 / 5），緊接著是<span data-term="self-perceived-learning-effectiveness">「有助理解抽象資料結構操作」</span>（4.11 / 5），這題問的是受試者主觀認為平台是否讓自己學得更好，屬於學習成效自評，跟測驗分數呈現的客觀學習成效是分開的證據。開放式回饋則指出，平台首次使用時仍有一定操作門檻，部分功能位置不夠直覺。
